    ...
    <footer className="bg-primary text-cream pt-16 pb-8 border-t border-primary-light/25">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="text-cream font-bold text-lg tracking-wider font-display block leading-none">OJASEARTH</span>
            ...
            <p className="text-xs text-cream/75 max-w-sm leading-relaxed">
              JASEARTH brings you pure, high-potency Ayurvedic solutions designed to help you achieve peak physical capability, mental clarity, and lifetime vitality.
            </p>
          </div>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <ul className="space-y-2 text-xs text-cream/70">
              <li><span className="block">Email: support@jasearth.com</span></li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center text-[10px] text-cream/50 gap-4">
          <p>© {new Date().getFullYear()} JASEARTH. All rights reserved. Made in India.</p>
